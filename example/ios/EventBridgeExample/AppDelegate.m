...
- (BOOL)onEventWithName:(NSString *)eventName info:(nullable NSDictionary *)info
{
...
- (BOOL)onEventWithName:(NSString *)eventName info:(nullable NSDictionary *)info callback:(nullable MSREventBridgeEventReceiverCallback)callback;
{
